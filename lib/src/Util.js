...
export function getKeyPressedInCanvas(canvas, evt) {
	var unicode = evt.charCode? evt.charCode : evt.keyCode
	return unicode
}
export function getMousePositionInCanvas(canvas, evt) {
...
export function isCursorWithinRectangle(x, y, width, height, mouseX, mouseY) {
...
export function getFirstTickableAfterXPosition(stave, x) {
	var note = null
...
export function getLastTickableBeforeXPosition(stave, x) {
	var note = null
...
export function getStemDirection(stave, y) {
 ...
 */
export function mergeProperties(obj1, obj2) {
	var obj3 = {}
